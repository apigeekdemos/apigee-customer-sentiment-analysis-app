...
var map = {
	...
	"./tables/tables.module": [
		...
		"app-pages-pages-module~tables-tables-module",
		"common",
		"tables-tables-module"
	],
...
var SmartTableService = /** @class */ (function () {
    function SmartTableService(httpClient) {
        this.httpClient = httpClient;
        //API_URL  =  'http://apigee-cs-test.apigee.net/sentiment-analysis-api';
        this.API_URL = 'http://demo39-test.apigee.net/v1/customersentiments';
    }
    //   getData() {
    ...
    SmartTableService.prototype.getData = function () {
        return this.httpClient.get(this.API_URL + "/comments?pagesize=100", { headers: { apikey: 'XlGDdGSk2G9G1A5Y2tP3VayXAsXPpsAV' } })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) { return Object.keys(data['comments']).map(function (k) {
            var name = 'invalid', comment = 'invalid', sentiment_image_url = 'https://storage.googleapis.com/apigee-apijam-images/eye-off.svg', score = 0, date = new Date().getTime();
            try {
                ...
                if (score > 0)
                    sentiment_image_url = "https://storage.googleapis.com/apigee-apijam-images/emoticon-happy.png";
                else if (score < 0)
                    sentiment_image_url = "https://storage.googleapis.com/apigee-apijam-images/emoticon-sad.png";
                else
                    sentiment_image_url = "https://storage.googleapis.com/apigee-apijam-images/emoticon-neutral.png";
            }
            catch (e) {
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(sidebarService, menuService, userService, analyticsService, layoutService, route) {
        var _this = this;
        ...
        this.route.queryParams.subscribe(function (params) {
            _this.username = params['username'] || 'kate';
        });
    }
    HeaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.userService.getUsers()
            .subscribe(function (users) { return _this.user = users[_this.username]; });
    };
...
var AppComponent = /** @class */ (function () {
    function AppComponent(analytics, route) {
        var _this = this;
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            _this.username_param = params['username'];
...
module.exports = __webpack_require__(/*! /Users/diegozuluaga/tools/git/apigee-customer-sentiment-analysis-app/app/src/main.ts */"./src/main.ts");
